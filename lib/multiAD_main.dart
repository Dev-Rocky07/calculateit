...
class CustomBannerAd extends StatefulWidget {
  ...
  const CustomBannerAd({super.key, required this.adUnitId});
...
class _PartyListScreenState extends State<PartyListScreen>
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ AdMob Test Ad IDs
    const topAdId = 'ca-app-pub-5642389083736086/7161298588';
    const bottomAdId = 'ca-app-pub-3940256099942544/6300978111';
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child: FutureBuilder(
                future: Future.delayed(const Duration(hours: 10)),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.done) {
                    // ✅ When Ad is Loaded
                    return SizedBox(
                      height: 60,
                      child: CustomBannerAd(adUnitId: topAdId),
                    );
                  } else {
              ...
              child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.done) {
                    ...
                    return SizedBox(
                      height: 60,
                      child: CustomBannerAd(adUnitId: bottomAdId),
                    );
                  } else {
                    // 🕓 Placeholder Box While Loading
                    return Container(
...
class _PartyDetailScreenState extends State<PartyDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    const secondtopAdId = 'ca-app-pub-3940256099942544/6300978111';
                ...
                child: FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.done) {
                      ...
                      return SizedBox(
                        height: 60,
                        child: CustomBannerAd(adUnitId: secondtopAdId),
                      );
                    } else {
                      // 🕓 Placeholder Box While Loading
                      return Container(
  ...
  Widget _settlementSummary(List<String> settlements, String summaryText) {
    const secondbottomAdId = 'ca-app-pub-3940256099942544/6300978111';

    return Column(
      children: [
        // ---------- Main Settlement Summary Container ----------
        Container(
          width: double.infinity,
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.done) {
                    ...
                    return SizedBox(
                      height: 60,
                      child: CustomBannerAd(adUnitId: secondbottomAdId),
                    );
                  } else {
                    // 🕓 Placeholder Box While Loading
                    return Container(
